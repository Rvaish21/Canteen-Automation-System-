<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_profile.aspx.cs" Inherits="about" EnableEventValidation="false"%>
            ...
            <table class="w-100">
                <tr>
                    ...
                    <td colspan="2" align=center>
                        <asp:Image ID="Image1" runat="server" Height="140px" Width="140px" CssClass=imageb />
                        ...
                        <asp:Button ID="Button3" runat="server" class="btn btn-rounded btn-primary" 
                            onclick="Button13_Click" Text="UPDATE PHOTO" Width="200px" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" class="tb5" Height="35px" 
                            placeholder="Employee Name" Width="400px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="TextBox8" runat="server" class="tb5" Height="35px" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox10" runat="server" class="tb5" Height="35px" 
                            placeholder="Cabin Number" Width="400px"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                ...
                <tr>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                    <td>
                        <asp:TextBox ID="TextBox11" runat="server" class="tb5" Height="35px" 
                            placeholder="Mobile Number" Width="400px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:TextBox ID="TextBox12" runat="server" class="tb5" Height="35px" 
                ...
                <tr>
                    ...
                    <td colspan="2" align=center>
                        <asp:Button ID="Button2" runat="server" class="btn btn-rounded btn-primary" 
                            onclick="Button1_Click" Text="UPDATE PROFILE" Width="200px" />
                        &nbsp;
                        </td>
                    <td>
                        &nbsp;</td>
