<%@ Page Language="C#" AutoEventWireup="true" CodeFile="office_add_emp.aspx.cs" Inherits="about" EnableEventValidation="false"%>
                ...
                <tr>
                    ...
                    <td colspan="2" align=center>
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Italic="True" 
                            ...
                            NavigateUrl="~/reg.aspx">Add New Employee</asp:HyperLink><br />
                        <br />
                    </td>
                    <td>
                        &nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="2" align=center>
                        <asp:Button ID="Button2" runat="server" class="btn btn-rounded btn-primary" 
                            onclick="Button1_Click" Text="SUBMIT" Width="500px" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
