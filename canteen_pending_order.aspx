<%@ Page Language="C#" AutoEventWireup="true" CodeFile="canteen_pending_order.aspx.cs" Inherits="about" EnableEventValidation="false"%>
    ...
    <div class="container">
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Italic="True" 
                ...
                NavigateUrl="~/reg.aspx">PENDING ORDERS</asp:HyperLink>
            <br />
            <strong>
            ...
            <asp:DataList ID="DataList1" runat="server" 
                onselectedindexchanged="DataList1_SelectedIndexChanged" Width="632px">
                <ItemTemplate>
                    <table class="w-100" 
                        ...
                        <tr>
                            <td class="style1">
                                ...
                                <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CCCCCC" 
                                    BorderStyle="Ridge" BorderWidth="1px" Height="140px" 
                                    ImageUrl='<%# "pro.ashx?id="+Eval("pid") %>' OnClick="ImageButton1_Click" 
                                    OnCommand="ImageButton1_Command" Width="200px" CssClass=imageb/>
                                </span>
                            </td>
                            <td class="style2">
                                &nbsp;</td>
                            <td class="style6">
                                ...
                                ,<br /><span class="col-black">Order Sent by </span>
                            ...
                            <td>
                                ...
                                <asp:ImageButton ID="ImageButton3" runat="server" BorderColor="#CCCCCC" 
                                    ...
                                    OnCommand="ImageButton1_Command" Width="140px" Visible="False" />
                                </span></strong>
                            </td>
                            <td class="style3">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td class="style1" colspan="5">
                                <asp:Image ID="Image2" runat="server" Height="15px" ImageUrl="~/line.png" 
                                    Width="700px" />
                            </td>
                            <td class="style1">
                                &nbsp;</td>
