<%@ Page Language="C#" AutoEventWireup="true" CodeFile="office_view_food1.aspx.cs" Inherits="about" EnableEventValidation="false"%>
                        ...
                        <tr>
                            <td class="style8" rowspan="6">
                                <asp:Image ID="Image1" runat="server" BorderColor="Red" BorderStyle="Double" 
                                    BorderWidth="1px" class="zoom" Height="300px" Width="400px" />
                                .</td>
                            <td class="style6">
                                &nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="style5" colspan="2">
                                ...
                                <asp:Button ID="Button1" runat="server" CssClass="myButton" 
                                    onclick="Button1_Click" Text="ORDER NOW" Width="200px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="style10">
