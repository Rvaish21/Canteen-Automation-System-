...
public partial class about : System.Web.UI.Page
{
    ...
    {
        cd.Open();
        string ss = "select max(eid) from emp";
        ...
        string sss = "insert into emp values('" + s2 + "','" + TextBox1.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','" + TextBox12.Text + "','" + TextBox13.Text + "',@img)";
        ...
        cd.Close();
        Response.Redirect("office_view_emp.aspx");
    }
