...
public partial class about : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script>alert('Please Login to view the product details')</script>");
    }
    ...
    {
        Response.Write("<script>alert('Please Login to Buy..')</script>");
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        c.Open();

        string s1 = "select * from food where tit='"+TextBox5.Text+"'order by pid desc";// where au='" + TextBox1.Text + "' ";
