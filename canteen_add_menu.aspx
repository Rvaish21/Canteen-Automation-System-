<%@ Page Language="C#" AutoEventWireup="true" CodeFile="canteen_add_menu.aspx.cs" Inherits="about" EnableEventValidation="false"%>
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <asp:HyperLink ID="HyperLink2" runat="server" Font-Italic="True" 
                                ...
                                NavigateUrl="~/reg.aspx">Add Food Item</asp:HyperLink>
                            <br />
                            <br />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" class="tb5" Height="35px" 
                                placeholder="Menu Item" Width="400px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBox8" runat="server" class="tb5" Height="35px" 
                                placeholder="Description" Width="400px"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox9" runat="server" class="tb5" Height="35px" 
                                placeholder="Price" Width="400px"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <asp:Button ID="Button2" runat="server" class="btn btn-rounded btn-primary" 
                                onclick="Button1_Click" Text="UPDATE" Width="300px" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
