<%@ Page Language="C#" AutoEventWireup="true" CodeFile="canteen_view_meny.aspx.cs" Inherits="about" EnableEventValidation="false"%>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="Red" class="style1">
                                            ...
                                            <asp:LinkButton ID="LinkButton1" runat="server" 
                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"pid") %>' 
                                                Font-Bold="True" ForeColor="#FF9999" onclick="ImageButton231_Click1" 
