...
public partial class about : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      //  Label1.Text = Session["una"].ToString();
        ...
        string s11 = "select * from emp";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
    ...
    protected void ImageButton1_Command1(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("office_view_emp1.aspx");
    }
