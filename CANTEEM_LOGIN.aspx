<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CANTEEM_LOGIN.aspx.cs" Inherits="ADMINLOGIN" %>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">CHILLZONE- CANTEEN</a>
            </div>
    ...
    <section class="content">
        ...
        <table class="w-100">
            <tr>
                ...
                <td align=center>
                    <img 
                        src="chef-cooking-fried-chicken-and-delicious-sign-png_103460.jpg" 
                        alt="evento" class="c" height="90" width="100"><br />
