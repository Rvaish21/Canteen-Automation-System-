<%@ Page Language="C#" AutoEventWireup="true" CodeFile="canteen_new_order.aspx.cs" Inherits="about" EnableEventValidation="false"%>
    ...
    <div class="container">
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Italic="True" 
                ...
                NavigateUrl="~/reg.aspx">NEW ORDERS</asp:HyperLink>
            <br />
            <strong>
