<%@ Page Language="C#" AutoEventWireup="true" CodeFile="office_view_emp.aspx.cs" Inherits="about" EnableEventValidation="false"%>
                        ...
                        <tr>
                            <td colspan="2" align=center>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:HyperLink 
                                    ...
                                    NavigateUrl="~/reg.aspx">EMPLOYEE LIST</asp:HyperLink>
                            </td>
                            <td>
                                &nbsp;</td>
                            <td>
                                                    ...
                                                    <td align="center">
                                                        <div class="polaroid5">
                                                            <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                ...
                                                                CssClass="imageb" Height="140px" ImageUrl='<%# "emp.ashx?id="+Eval("eid") %>' 
                                                            ...
                                                            <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Small" 
                                                                ForeColor="Black" Text='<%# DataBinder.Eval(Container.DataItem,"desi") %>'></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
